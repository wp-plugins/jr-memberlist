...
if ($fp = fopen('http://www.jakeruston.co.uk/pluginslink4.php', 'r')) {
   $content = '';
...
update_option("jr_memberlist_links_choice", "");
}
}
...
function memberlist_footer_plugin_support() {
  $pshow = "<p style='font-size:x-small'>Memberlist Plugin created by <a href='http://www.jakeruston.co.uk'>Jake Ruston</a> - ".get_option('jr_memberlist_links_choice')."</p>";
  echo $pshow;
}
