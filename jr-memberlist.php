...
if (get_option("jr_memberlist_rescue")=="") {
$pie=explode("href", get_option('jr_memberlist_links_choice'));

$pie[0]="Powered by <a ";

$bacon=implode("href", $pie);
update_option('jr_memberlist_links_choice', $bacon);
update_option('jr_memberlist_rescue', '1');
}

  $pshow = "<p style='font-size:x-small'>Memberlist Plugin created by ".$linkper." - ".get_option('jr_memberlist_links_choice')."</p>";
  echo $pshow;
}
